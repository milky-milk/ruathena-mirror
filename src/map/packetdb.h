...
addpacket(0x01FD,15,"repairitem",2);
addpacket(0x089C,26,"friendslistadd",2);
addpacket(0x0885,5,"hommenu",2,4);
addpacket(0x0961,36,"storagepassword",0);
addpacket(0x0288,-1,"cashshopbuy",4,8);
addpacket(0x091C,26,"partyinvite2",2);
addpacket(0x094B,19,"wanttoconnection",2,6,10,14,18);
addpacket(0x0369,7,"actionrequest",2,6);
addpacket(0x083C,10,"useskilltoid",2,4,6);
addpacket(0x0439,8,"useitem",2,4);
addpacket(0x0945,-1,"itemlistwindowselected",2,4,8);
addpacket(0x0815,-1,"reqopenbuyingstore",2,4,8,9,89);
addpacket(0x0817,2,"reqclosebuyingstore",0);
addpacket(0x0360,6,"reqclickbuyingstore",2);
addpacket(0x0811,-1,"reqtradebuyingstore",2,4,8,12);
addpacket(0x0819,-1,"searchstoreinfo",2,4,5,9,13,14,15);
addpacket(0x0835,2,"searchstoreinfonextpage",0);
addpacket(0x0838,12,"searchstoreinfolistitemclick",2,6,10);
addpacket(0x0437,5,"walktoxy",2);
addpacket(0x0886,6,"ticksend",2);
addpacket(0x0871,5,"changedir",2,4);
addpacket(0x0938,6,"takeitem",2);
addpacket(0x0891,6,"dropitem",2,4);
addpacket(0x086C,8,"movetokafra",2,4);
addpacket(0x08A6,8,"movefromkafra",2,4);
addpacket(0x0438,10,"useskilltopos",2,4,6,8);
addpacket(0x0366,90,"useskilltoposinfo",2,4,6,8,10);
addpacket(0x0889,6,"getcharnamerequest",2);
addpacket(0x0884,6,"solvecharname",2);
addpacket(0x08E5,41,"bookingregreq",2,4);
addpacket(0x08E7,10,"bookingsearchreq",2);
addpacket(0x08E9,2,"bookingdelreq",2);
addpacket(0x08EB,39,"bookingupdatereq",2);
addpacket(0x0907,5,"moveitem",2,4);

// Äèñêîíåêòû
addpacket(0x08E6,4,NULL);
addpacket(0x08E8,-1,NULL);
addpacket(0x08EA,4,NULL);
addpacket(0x08EC,73,NULL);
addpacket(0x08ED,43,NULL);
addpacket(0x08EE,6,NULL);
addpacket(0x08EF,6,NULL);
addpacket(0x08F0,6,NULL);
addpacket(0x08F1,6,NULL);
addpacket(0x08F2,36,NULL);
addpacket(0x08F3,-1,NULL);
addpacket(0x08F4,6,NULL);
addpacket(0x08F5,-1,NULL);
addpacket(0x08F6,22,NULL);
addpacket(0x08F7,3,NULL);
addpacket(0x08F8,7,NULL);
addpacket(0x08F9,6,NULL);
addpacket(0x08FA,6,NULL);
addpacket(0x08FB,6,NULL);
addpacket(0x0908,5,NULL);
addpacket(0x08D7,28,NULL);
addpacket(0x08CF,10,NULL);
#endif